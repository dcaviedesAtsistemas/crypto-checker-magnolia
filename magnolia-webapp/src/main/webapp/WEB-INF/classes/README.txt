...
This package contains:
   ...
   Magnolia Core 5.6.4
   Magnolia Internationalization Framework 5.6.4
   Magnolia JAAS 5.6.4
   Magnolia Rendering 5.6.4
   Magnolia Templating 5.6.4
   Magnolia Templating for JSP 5.6.4
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.6.5.html
